...
const DICT = {
  pt: {
    ...
    menuPreview: "PREVIEW",
    menuHomeLabel: "Home",
    menuHomeDescription: "O ponto de partida do meu trabalho criativo.",
    menuAboutLabel: "Sobre mim",
    menuAboutDescription: "Minha história, processo e forma de criar.",
    menuDesignLabel: "Design Gallery",
    menuDesignDescription: "Branding, sistemas editoriais e social media.",
    menuMotionLabel: "Motion Archive",
    menuMotionDescription: "Edição, motion e narrativas em movimento.",
    menuContactLabel: "Vamos conversar",
    menuContactDescription: "Vamos transformar uma ideia em algo memorável.",
    menuPreviewSelectedEntry: "Entrada selecionada",
    menuPreviewCreativeFields: "Design · Motion · Código",
    menuPreviewProfile: "Perfil",
    menuPreviewVisualSystems: "Sistemas visuais",
    menuPreviewDesignFields: "Branding / Editorial / Social",
    menuPreviewMotionStudy: "Estudo de motion",
    menuPreviewMotionFields: "Edição · Ritmo · Narrativa",
    menuPreviewAvailable: "Disponível para projetos selecionados",
    menuPreviewMemorable: "Torne memorável.",
    menuPreviewTalk: "Conversar",
    menuPreviewConversation: "Ideias ganham forma através da conversa.",
    ...
    galleryDesignPosts: "Posts estáticos",
    galleryDesignCarousels: "Carrosséis",
    galleryDesignStories: "Stories",
    galleryDetailCtaEyebrow: "Próximo Projeto",
    galleryDetailCtaContinue: "Continuar",
    galleryDetailCtaViewProject: "Ver projeto",
    ...
    galleryPlaygroundPiece08: "Identidade Save Our Seas",
  ...
  en: {
    ...
    menuPreview: "PREVIEW",
    menuHomeLabel: "Home",
    menuHomeDescription: "The starting point for my creative work.",
    menuAboutLabel: "About me",
    menuAboutDescription: "My story, process and way of creating.",
    menuDesignLabel: "Design Gallery",
    menuDesignDescription: "Branding, editorial systems and social media.",
    menuMotionLabel: "Motion Archive",
    menuMotionDescription: "Editing, motion and stories in movement.",
    menuContactLabel: "Let's talk",
    menuContactDescription: "Let's turn an idea into something memorable.",
    menuPreviewSelectedEntry: "Selected entry",
    menuPreviewCreativeFields: "Design · Motion · Code",
    menuPreviewProfile: "Profile",
    menuPreviewVisualSystems: "Visual systems",
    menuPreviewDesignFields: "Branding / Editorial / Social",
    menuPreviewMotionStudy: "Motion study",
    menuPreviewMotionFields: "Edit · Rhythm · Narrative",
    menuPreviewAvailable: "Open for selected projects",
    menuPreviewMemorable: "Make it memorable.",
    menuPreviewTalk: "Let's talk",
    menuPreviewConversation: "Ideas become form through conversation.",
    ...
    galleryDesignPosts: "Static posts",
    galleryDesignCarousels: "Carousels",
    galleryDesignStories: "Stories",
    galleryDetailCtaEyebrow: "Next Project",
    galleryDetailCtaContinue: "Continue",
    galleryDetailCtaViewProject: "View project",
    ...
    galleryPlaygroundPiece08: "Save Our Seas identity",
  ...
  es: {
    ...
    menuPreview: "PREVIEW",
    menuHomeLabel: "Home",
    menuHomeDescription: "El punto de partida de mi trabajo creativo.",
    menuAboutLabel: "Sobre mí",
    menuAboutDescription: "Mi historia, proceso y forma de crear.",
    menuDesignLabel: "Design Gallery",
    menuDesignDescription: "Branding, sistemas editoriales y redes sociales.",
    menuMotionLabel: "Motion Archive",
    menuMotionDescription: "Edición, motion y narrativas en movimiento.",
    menuContactLabel: "Hablemos",
    menuContactDescription: "Convirtamos una idea en algo memorable.",
    menuPreviewSelectedEntry: "Entrada seleccionada",
    menuPreviewCreativeFields: "Diseño · Motion · Código",
    menuPreviewProfile: "Perfil",
    menuPreviewVisualSystems: "Sistemas visuales",
    menuPreviewDesignFields: "Branding / Editorial / Social",
    menuPreviewMotionStudy: "Estudio de motion",
    menuPreviewMotionFields: "Edición · Ritmo · Narrativa",
    menuPreviewAvailable: "Disponible para proyectos seleccionados",
    menuPreviewMemorable: "Hazlo memorable.",
    menuPreviewTalk: "Hablemos",
    menuPreviewConversation: "Las ideas toman forma a través de la conversación.",
    ...
    galleryDesignPosts: "Posts estáticos",
    galleryDesignCarousels: "Carruseles",
    galleryDesignStories: "Stories",
    galleryDetailCtaEyebrow: "Próximo Proyecto",
    galleryDetailCtaContinue: "Continuar",
    galleryDetailCtaViewProject: "Ver proyecto",
    ...
    galleryPlaygroundPiece08: "Identidad Save Our Seas",
